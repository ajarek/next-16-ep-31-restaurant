      ...
      <div className='  py-12 flex flex-col md:flex-row justify-between gap-12'>
        ...
        <div className='flex flex-col gap-6 max-w-sm'>
          ...
          <p className='text-muted-foreground text-sm leading-relaxed'>
            Still Sea is more than a restaurant — it&apos;s where fine taste
            meets timeless ambiance. Join us for unforgettable dining moments,
            crafted with passion, precision, and elegance.
          </p>
        </div>
      ...
      <div className='max-w-7xl mx-auto px-6 pb-10'>
        ...
        <div className='text-center flex flex-col gap-2 text-sm text-muted-foreground mt-2'>
          <p className='font-medium tracking-wide'>
            © 2026 Still Sea. All rights reserved.
          </p>
          <p className='tracking-wide'>
            Designed by{" "}
            <Link
              href='#'
              className='underline italic hover:text-primary transition-colors'
            >
              Ajarek Calvert
            </Link>
          </p>
