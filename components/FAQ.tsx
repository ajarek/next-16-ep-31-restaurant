...
const faqData = [
  {
    ...
    answer:
      "We recommend making a reservation, especially for weekends or large groups, to ensure availability and a seamless dining experience.",
  },
  {
    question: "Do you offer vegetarian or vegan options?",
    answer:
      "Yes, we have a variety of vegetarian and vegan dishes. Just let our team know your preferences and we'll guide you through the menu.",
  },
  {
    question: "Can I book a private event?",
    answer:
      "Yes, we host private events for all occasions. Contact us in advance to reserve and plan a memorable experience for your guests.",
  },
  {
    question: "Is there a dress code?",
    answer:
      "We suggest smart casual attire, but there's no strict dress code, feel free to come as you are and enjoy a relaxed dining experience.",
  },
  {
    question: "Do you accommodate food allergies?",
    answer:
      "Absolutely. Let our staff know your allergies when ordering, and we'll ensure your meal is prepared with extra care and safety.",
  },
]
