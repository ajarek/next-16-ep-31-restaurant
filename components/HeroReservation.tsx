    ...
    <div className=' w-full flex flex-col items-center justify-center gap-8 '>
      <div className='relative w-full h-[480px] md:h-[600px] '>
        ...
        <div className='absolute inset-0 bg-black/50 rounded-xl flex flex-col items-center justify-center gap-8'>
          ...
          <h1 className='text-5xl font-bold text-primary text-center '><TypewriterEffect words={words} /></h1>
          <p className=' text-center text-white text-xl max-w-2xl '>From intimate gatherings to grand celebrations, Still Sea offers the perfect ambiance, tailored menus, and exceptional service to make every event truly special.</p>
