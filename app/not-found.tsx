    ...
    <main className='flex flex-col items-center justify-center h-screen gap-6 bg-background px-4'>
      <div className='flex flex-col items-center gap-2 text-center'>
        <div className='relative text-2xl group-hover:scale-110 transition-transform duration-300'>
          <Image src="/images-home/logo.webp" alt="Vercel Logo" width={220} height={220} className="object-contain rounded-full" />
        ...
        <p className='max-w-125 text-muted-foreground mt-2'>
          It looks like we&apos;ve lost our way. The page you&apos;re looking for may have been 
          deleted, moved, or is temporarily unavailable.
        </p>
      </div>
