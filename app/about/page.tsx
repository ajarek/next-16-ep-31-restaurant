  ...
  return (
    <div className='min-h-screen bg-linear-to-b from-primary/20 to-secondary/10 flex flex-col items-center justify-start gap-8 px-8 sm:px-16 lg:px-24 pt-32'>
      ...
      <div className='relative w-full flex flex-col items-center justify-center my-8'>
        <div className="absolute top-20 left-10 w-120 p-4 bg-background/80 border-2 shadow-2xl z-10 rounded-2xl">
          <h2 className="text-2xl font-bold text-primary text-center mb-8 ">Our Philosophy</h2>
          <p>
        ...
        <div className="absolute right-10 bottom-20 w-120 p-4 bg-background/80 border-2 shadow-2xl z-10 rounded-2xl">
          <h2 className="text-2xl font-bold text-primary text-center mb-8 ">Our Ambiance</h2>
          <p>
            Elegant lighting, soft textures, and curated sounds come together to create an atmosphere where every meal feels intimate, luxurious, and truly special.
          </p>
        </div>
      </div>
    </div>
